	...
	<div class="section">
		<div class="container">
			<div class="row">
				...
				<!--../servcontrol.do?idformulario=1&tipoformulario=11" class="btn btn-default-->
						<a href="../servcontrol.do?idformulario=1&tipoformulario=11" class="btn btn-default" class="btn btn-default">Consultar Todos os Clientes</a>
