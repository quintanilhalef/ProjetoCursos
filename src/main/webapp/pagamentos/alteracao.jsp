...
<body>
	...
	<div class="section">
		<div class="container">
			...
			<div class="row">
				<div class="col-md-12">
					<form class="form-horizontal" role="form" action="http://localhost:8080/ProjetoWEB/servcontrol.do" method="post">
						...
						<div class="form-group">
							...
							<div class="col-sm-9">
								<input type="number" name="cdcurso" class="form-control"
									id="inputCURSO" placeholder="CURSO">
							</div>
						</div>
						<div class="form-group">
							<div class="col-sm-3">
								<label for="inputDATA" class="control-label">Informar a
									NOVA DATA DE INSCRICAƒO:</label>
							</div>
							<div class="col-sm-9">
